...
# Required arguments 
# --BARCODE
#	The barcode file, generated by cropseq_count.py
# --RDS
...
# Optional arguments
# --RRAPATH
#	The path of the external RRA program.
# --LABEL
#	The label of the output files.
# --NEGCTRL 
#	The name of the negative control gene. By default, no negative control gene is used.
# --KEEPTMP
